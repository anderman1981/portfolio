<div style="margin-top:1rem">
    <div style="display:flex;align-items:center;gap:.75rem;color:#94a3b8;font-size:.8rem;margin:.5rem 0 1rem">
        <span style="flex:1;height:1px;background:#e2e8f0"></span>o<span style="flex:1;height:1px;background:#e2e8f0"></span>
    </div>
    <a href="{{ route('google.redirect') }}"
       style="display:flex;align-items:center;justify-content:center;gap:.6rem;width:100%;padding:.65rem 1rem;border:1px solid #e2e8f0;border-radius:.6rem;background:#fff;color:#1e293b;font-weight:600;font-size:.9rem;text-decoration:none;transition:background .15s"
